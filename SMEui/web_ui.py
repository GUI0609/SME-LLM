...
from pages.google_scholar import query_in_google_scholar
from pages.compress import process_text
from langchain.tools import BaseTool
import pandas as pd
class GoogleScholarSearch(BaseTool):
    name = 'google_scholar_tool'
    description = 'The google_scholar_tool need a parameter keyword, to query in google scholar and get related publications information'
    def _run(self, keyword):
        ...
        return process_text(text,0.7,1000)
...
#谷歌学术搜索
google_scholar_tool = GoogleScholarSearch()
#查找pubchem分子信息
...
user_proxy.register_function(
    function_map={
        ...
        google_scholar_tool.name:google_scholar_tool._run,
